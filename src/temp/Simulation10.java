...
public class Simulation10 extends Simulation {
...
//Моделирование активности агентов	
	public void step(SimState state) {
		Iterable li = grid.getObjects();
		for (Object agent : li) {((ProtoAgent)agent).step();
		}
	}
//Установка задержки для моделирования агентов
	...
	public Factory getAgentFactory() {
		return new Factory<ProtoAgent>(){
			@Override
			public ProtoAgent create() {
				return new Eater();
			}
		};
		}
