...
public class EditingModalGraphMouse2<V,E> extends AbstractModalGraphMouse implements ModalGraphMouse, ItemSelectable {

	protected Factory<V> vertexFactory;
	protected Factory<E> edgeFactory;
	protected EditingGraphMousePlugin2<V,E> editingPlugin;
	 ...
	 *
	 */
	public EditingModalGraphMouse2(RenderContext<V,E> rc,
    ...
    protected void loadPlugins() {
		...
		editingPlugin = new EditingGraphMousePlugin2<V,E>(vertexFactory, edgeFactory);
    ...
    public JComboBox getModeComboBox() {
		if(modeBox == null) {
			modeBox = new JComboBox(new Mode[]{Mode.EDITING, Mode.PICKING, Mode.TRANSFORMING});
	 ...
	 */
	public EditingGraphMousePlugin2<V, E> getEditingPlugin() {
	...
	public void setDirected(EdgeType directed) {
		editingPlugin.setDirected(directed);
	}
