 ...
 *
 */
public class EditingGraphMousePlugin2<V,E> extends AbstractGraphMousePlugin implements
    ...
    protected EdgeType edgeIsDirected=EdgeType.UNDIRECTED;
    protected Factory<V> vertexFactory;
    protected Factory<E> edgeFactory;
    
    public EditingGraphMousePlugin2(Factory<V> vertexFactory, Factory<E> edgeFactory) {
     ...
     * @param modifiers
     */
    public EditingGraphMousePlugin2(int modifiers, Factory<V> vertexFactory, Factory<E> edgeFactory) {
        super(modifiers);
