...
public class SimpleProperties extends Properties implements java.io.Serializable
    ...
    */
    public SimpleProperties(Object o, boolean includeSuperclasses, boolean includeGetClass, boolean includeDomains)
        {
        object = o;
        if (o!=null && o instanceof simbigraph.util.Proxiable)
            object = ((simbigraph.util.Proxiable)(o)).propertiesProxy();
        else if (o!=null && o instanceof simbigraph.util.Propertied)
            auxillary = ((simbigraph.util.Propertied)(o)).properties();
