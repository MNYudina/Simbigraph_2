 ...
 * 
 * Specifies the options document java
 */ 
public class JavaDocument extends DefaultStyledDocument {
	...
	public JavaDocument() {
		...
		StyleConstants.setForeground(quote, new Color(0, 0, 192));
	...
	/**
	 * true if this method to contain the end delimiter
	 */
	...
	/**
	 * Do this if you have found a start delimiter
	...
	/**
	 * updates the colored text and prepares for undo event
	 */
	...
	/**
	 * updates the colored text and does the undo operation
	 */
	...
	/**
	 * defines java single line delimiter
	 */
