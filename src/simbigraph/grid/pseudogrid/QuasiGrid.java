...
import simbigraph.grid.model.GridAdder;
...
public interface QuasiGrid<T>{
	...
	*//**
	 ...
	 *             dimensions.
	 *//*
	boolean moveTo(T object, QuasiGridPoint);
	...
	*//**
	 ...
	 *         in the space.
	 *//*
	QuasiGridPoint getLocation(Object obj);
	...
	*//**
	 ...
	 *//*
	T getObjectAt(QuasiGridPoint location);
	...
	*//**
	 ...
	 * @return the object at the specified location.
	 *//*
	Iterable<T> getObjectsAt(QuasiGridPoint location);
	...
	*//**
	 ...
	 * @return the object at the specified location.
	 *//*
	T getRandomObjectAt(QuasiGridPoint location);
	...
	*//**
	 ...
	 *             grid dimensions.
	 *//*
	QuasiGridPoint moveByDisplacement(T object, QuasiGridPoint displacement);
	...
	*//**
	 ...
	 *//*
	boolean isPeriodic();
	public Map<T, QuasiPointHolder>getLocationMap();
	public Map<QuasiGridPoint, Object> getLocationStorage();
}
*/