...
public class CommonGraphics {
	 ...
	 * 
	 * Copyright 1997-2008 Sun Microsystems, Inc. All Rights Reserved. DO NOT
	 ...
	 * LICENSE_GPL_CLASSPATH file that accompanied this code.
	 * 
	 ...
	 * have any questions.
	 * 
	 * $Revision: 1.6 $ $Date: 2008/02/28 20:17:21 $ $State: Exp $
	 * 
	 * 
	 ...
	 * 
	 * Author: August Lammersdorf, www.InteractiveMesh.com/org Version: 1.4
	 * Date: 2008/12/11
	 */

	/**
	 * An AWTShapeExtrusion object is used to describe the extrusion path for a
	 * AWTShapeExtruder object. The extrusion path defines the edge contour of
	 * its AWT Shape object. This contour is perpendicular to the face of the
	 * AWT Shape and must be monotonic in x.
	 * <P>
	 * The shape of the extrusion path is, by default, a straight line from 0.0
	 * to 0.2 (known as a straight bevel). The shape may be modified via the
	 * extrusionShape parameter, also a <code>java.awt.Shape</code> object that
	 * describes the 3D contour of the AWT Shape object.
	 * </p>
	 * <P>
	 * User is responsible for data sanity and must make sure that
	 * extrusionShape does not cause intersections. Else undefined output may be
	 * generated.
	 * </p>
	 * <p>
	 * AWTShapeExtrusion is a generalized version of
	 * <code>javax.media.j3d.FontExtrusion</code>.
	 * </p>
	 * 
	 * @version 1.4
	 * @see AWTShapeExtruder
	 */
	public static class AWTShapeExtrusion {

		private float length = 0.2f;
		private Shape shape = null;
		private Point2f[] pnts = null;

		private boolean isT3DExtrusion = false; // v 1.3 / 1.4
		 ...
		 * <P>
		 * 
		 * A null extrusion shape specifies that a straight line from 0.0 to 0.2
		...
		/**
		 * Constructs an AWTShapeExtrusion object with a straight bevel
		 * extrusion shape, a straight line from 0.0 to depth.
		 * 
		 * @param depth
		 *            length of extrusion
		 * @throws IllegalArgumentException
		 *             if depth is less than 0.0
		 * @see AWTShapeExtruder
		 */
		public AWTShapeExtrusion(float depth) {
			if (depth < 0.0f)
				throw new IllegalArgumentException(
						"Length of extrusion is less than 0.0; depth = "
						+ depth + " !");
			this.length = depth;
		}

		/**
		 * Constructs an AWTShapeExtrusion object with the specified extrusion
		 * shape, using the default tessellation tolerance. The specified shape
		 * is used to construct the edge contour. Each shape begins with an
		 * implicit point at 0.0. Contour must be monotonic in x.
		 * 
		 * @param extrusionShape
		 *            the shape object to use to generate the extrusion path. A
		 *            null shape specifies that a straight line from 0.0 to 0.2
		 *            (straight bevel) is used.
		 * 
		 * @throws IllegalArgumentException
		 *             if multiple contours in extrusionShape, or contour is not
		 *             monotonic or least x-value of a contour point is not 0.0f
		 * 
		 * @see AWTShapeExtruder
		 */
		...
		/**
		 * Constructs an AWTShapeExtrusion object with the specified extrusion
		 * shape, using the specified tessellation tolerance. The specified
		 * shape is used to construct the edge contour. Each shape begins with
		 * an implicit point at 0.0. Contour must be monotonic in x.
		 * 
		 * @param extrusionShape
		 *            the shape object to use to generate the extrusion path. A
		 *            null shape specifies that a straight line from 0.0 to 0.2
		 *            (straight bevel) is used.
		 * @param tessellationTolerance
		 *            the tessellation tolerance value used in tessellating the
		 *            extrusion shape. This corresponds to the
		...
		/**
		 * Returns the AWTShapeExtrusion's shape parameter. This parameter is
		 * used to construct the edge contour.
		 * 
		 * @return extrusionShape the shape object used to generate the
		 *         extrusion path, or <code>null</code> if a straight bevel
		 *         extrusion shape is set
		 * 
		 */
		...
		/**
		 * Sets the AWTShapeExtrusion's shape parameter. This parameter is used
		 * to construct the edge contour.
		 * 
		 * @param extrusionShape
		 *            the shape object to use to generate the extrusion path. A
		 *            null shape specifies that a straight line from 0.0 to 0.2
		...
		/**
		 * Sets the AWTShapeExtrusion's shape to a straight bevel extrusion
		 * shape, a straight line from 0.0 to depth.
		 * 
		 * @param depth
		 *            length of extrusion
		 * @throws IllegalArgumentException
		...
		private void updateExtrusionShape() {
			...
			// increasing, non-self-intersecting curve. Throw exception
			// otherwise
			while (!pIt.isDone()) {
				...
				if (flag == PathIterator.SEG_LINETO) {
					...
					// monotonic decreasing. It is set to -1 initially and
					// remains
					...
					if (((inc == 0) && (prevX > vertex.x))
						...
						throw new IllegalArgumentException(
						"AWTShapeExtrusion:invalid shape- non-monotonic");
					...
					if (n != 0)
						throw new IllegalArgumentException(
						"AWTShapeExtrusion:invalid shape- multiple contours");
			...
			if (pnts[0].x != 0.0f)
				throw new IllegalArgumentException(
				"AWTShapeExtrusion: invalid shape - shape must start or end at x = 0.0f");
		 ...
		 * extrusion shape will be created.
		 * <P>
		 * This corresponds to the <code>flatness</code> parameter in the
		 * <code>java.awt.Shape.getPathIterator</code> method.
		 * 
		 * @param tessellationTolerance
		 *            the tessellation tolerance value used in tessellating the
		 ...
		 * 
		 * @return true if Text3D-style extrusion is enabled, false if it is
		 *         disabled
		 ...
		 * <P>
		 * This flag allows to switch to Text3D-style extrusion combined with
		 * the advantages of smooth shading and solid geometry. This provides an
		 * (interim) alternative for the not yet perfectly functioning curved
		 * shape extrusion.
		 * 
		 * The default state is <code>false</code>.
		 * 
		 * @param enable
		 *            true or false to enable or disable Text3D-style extrusion
		 * @since AWT Shape Extruder 2.2
		 */
		 ...
		 * 
		 * @return outline of the specified extrusion shape, or
		 *         <code>null</code> if a straight bevel extrusion shape is set
		 */
		...
		/**
		 * Returns the length of extrusion either of the straight bevel
		 * extrusion shape or of the specified extrusion shape.
		 * 
	 ...
	 * above mentioned. A copy is attached as LICENSE_GPL_CLASSPATH.txt.
	 * 
	 * Author: August Lammersdorf, www.InteractiveMesh.com/org Version: 1.7
	 * Date: 2008/12/19
	 */

	/**
	 * AWTShapeExtruder converts a Java 2D <code>Shape</code>, called here AWT
	 * Shape, to a 3D geometry in a factory manner.
	 * <p>
	 * Each AWTShapeExtruder object has the following parameters:
	 * <P>
	 * <UL>
	 * <LI>Tessellation tolerance - precision value used in tessellating the AWT
	 * Shape.</LI>
	 * <P>
	 * <LI>Extrusion path - creates depth by describing how the edge of the AWT
	 * Shape varies in the Z axis.</LI>
	 * <P>
	 * <LI>Crease angle - determines the smooth shading of the 3D geometry.</LI>
	 * <P>
	 * <LI>Geometry transform - transformation applied to the generated
	 * coordinates and normals.</LI>
	 * </UL>
	 * <P>
	 * 
	 * According to the current state of these parameters a AWTShapeExtruder
	 * object creates for a given AWT Shape or for given characters a
	 * <code>javax.media.j3d.GeometryArray</code>
	 * 
	 * <UL>
	 ...
	 * <br/>
	 * 
	 * AWTShapeExtruder is a generalized version of
	 * <code>javax.media.j3d.Font3D</code>.
	 * </p>
	 * 
	 * @version 1.7
	 ...
	 * @see String3D
	 */
	public static class AWTShapeExtruder {
		...
		/**
		 * Constructs an AWTShapeExtruder object using the default values for
		 * the extrusion path, the tessellation tolerance, the crease angle, and
		...
		/**
		 * Constructs an AWTShapeExtruder object from the specified
		 * AWTShapeExtrusion object, using the default values for the
		 * tessellation tolerance, the crease angle, and the geometry transform.
		 * <p>
		 * The default values are as follows:
		 * <ul>
		 * tessellation tolerance : 0.01<br>
		 ...
		 * the AWT Shape object. Passing null for the AWTShapeExtrusion
		 * parameter results in no extrusion being done.
		 * 
		 * @param extrudePath
		 *            the extrusion path used to describe how the edge of the
		 *            AWT Shape varies along the Z axis
		 */
		...
		/**
		 * Constructs an AWTShapeExtruder object from the specified
		 * AWTShapeExtrusion object, using the specified tessellation tolerance
		 * and the default values for the crease angle and the geometry
		 * transform.
		 * <p>
		 * The default values are as follows:
		 * <ul>
		 ...
		 * @param tessellationTolerance
		 *            the tessellation tolerance value used in tessellating the
		 *            AWT Shape. This corresponds to the <code>flatness</code>
		 *            parameter in the
		 *            <code>java.awt.Shape.getPathIterator</code> method.
		 * @param extrudePath
		 *            the extrusion path used to describe how the edge of the
		 ...
		 * Constructs an AWTShapeExtruder object from the specified
		 * AWTShapeExtrusion object, using the specified tessellation tolerance
		 * and crease angle and the default value for the geometry transform.
		 * <P>
		...
		/**
		 * Returns the AWTShapeExtrusion object used to describe how the edge of
		 * the AWT Shape varies along the Z axis.
		 * <P>
		 * 
		...
		/**
		 * Sets the AWTShapeExtrusion object used to describe how the edge of
		 * the AWT Shape varies along the Z axis. Passing null results in no
		...
		/**
		 * Returns the tessellation tolerance with which the geometry of the AWT
		...
		/**
		 * Sets the tessellation tolerance with which the geometry of the AWT
		 * Shape will be created.
		 * <P>
		 * 
		 * The default tolerance value is 0.01.
		...
		/**
		 * Sets the crease angle in radians. The specified value will be clamped
		 * to [0, Math.PI].
		 * <P>
		 * 
		 * The default value is 0.767944871 radians (44 degrees)
		 * 
		 * @param creaseAngle
		 *            an angle between surface normals to determin if adjacent
		 *            triangles are shaded smoothly across the edge
		 */
		...
		// V 1.7
		/**
		 * Copies the transform component of this AWTShapeExtruder object into
		 * the passed Transform3D object.
		 * <P>
		 * 
		 ...
		 *                if transform is <code>null</code>
		 */
		...
		// V 1.7
		/**
		 * Sets the transform component of this AWTShapeExtruder object to the
		 * value of the passed transform.
		 * <P>
		 * 
		 * The specified transform will be applied to the generated coordinates
		 * and normals in addition to a shape's affine transformation resp. a
		 * string's position value.
		 * <P>
		 * 
		 * The font size of a text string and the tesselation tolerance
		 * determine the precision and resolution of the tesselated geometry.
		 * These values should be set according to the desired quality.
		 * 
		 * Finally, this transform allows to scale the geometry to achieve a
		 * scene conform character size. Of course, rotation and translation
		 * components can be set as well.
		 * <P>
		 * 
		 * See also the sample code on this javadoc's overview page.
		 * <P>
		 * 
		 * The default transform is the identity matrix, so that the generated
		 ...
		 *                if transform is not invertable
		 */
		public void setGeometryTransform(Transform3D transform) {
			...
			transform.get(mat);
			isScaleTranslation = (mat[1] == 0.0f && mat[2] == 0.0f
					&& mat[4] == 0.0f && mat[6] == 0.0f && mat[8] == 0.0f
					&& mat[9] == 0.0f && mat[12] == 0.0f && mat[13] == 0.0f
					&& mat[14] == 0.0f && mat[15] == 1.0f);
		...
		/**
		 * Returns a GeometryArray for the given AWT Shape object according to
		 * the specified extrusion path, tessellation tolerance, crease angle,
		 * and geometry transform of this AWTShapeExtruder object.
		 * 
		 ...
		 * 
		 * @param shape
		 *            AWT Shape from which to generate a tessellated extruded
		 *            geometry
		 * @param trans
		 *            an optional AffineTransform to be applied to the
		 *            coordinates of the shape's path iterater, or
		 *            <code>null</code> if untransformed coordinates are desired
		 * @return a GeometryArray or <code>null</code> if no GeometryArray
		 *         could be created
		 */
		public GeometryArray getGeometry(Shape shape, AffineTransform trans) {

			PathIterator pIt = shape.getPathIterator(trans,
					tessellationTolerance);

			GeometryArray geomArray = createGeometry(pIt, false, true); // by
			// copy,
			// Geometry
			// transform
		...
		// V 1.4
		/**
		 * Returns a GeometryArray representing the outline of the given AWT
		 * Shape object according to the specified tessellation tolerance and
		 * geometry transform of this AWTShapeExtruder object.
		 * 
		 * Neither the extrusion path nor the crease angle attributes are
		 * applied.
		 * 
		 * If an optional AffineTransform is specified, the coordinates returned
		 * by the shape's path iterator are transformed accordingly.
		 * <p>
		 * The returned GeometryArray includes line primitives and normals which
		 * are directed along the positive Z axis (0, 0, 1).
		 * 
		 * @param shape
		 *            AWT Shape from which to generate an outline geometry
		 * @param trans
		 *            an optional AffineTransform to be applied to the
		 *            coordinates of the shape's path iterater, or
		 *            <code>null</code> if untransformed coordinates are desired
		 ...
		 *         could be created
		 */
		public GeometryArray getOutlineGeometry(Shape shape,
				AffineTransform trans) {

			PathIterator pIt = shape.getPathIterator(trans,
					tessellationTolerance);
			// incl normals, by copy, geometry transform
			GeometryArray geomArray = createLineStripGeometry(pIt, true, false,
					true);
		...
		/**
		 * Returns a GeometryArray for the given characters according to the
		 * specified extrusion path, tessellation tolerance, crease angle, and
		 * geometry transform of this AWTShapeExtruder object
		 * 
		 * and according to the specified Font object which describes the font
		 * name (Helvetica, Courier, etc.), the font style (bold, italic, etc.),
		 * and point size. The flip value allows to reverse the Font's Y-axis
		 ...
		 * 
		 * @param chars
		 *            characters from which to generate tessellated glyphs
		 * @param font
		 *            the Java 2D Font used to create the glyphs
		 * @param flip
		 *            if <code>true</code> the Font's Y-axis downwards
		 *            orientaton is reversed
		 * @return a GeometryArray or <code>null</code> if no GeometryArray
		 *         could be created
		 * 
		 * @see String3D
		...
		/**
		 * Returns an AWT Shape of the specified characters according to the
		 * specified Font object which describes the font name (Helvetica,
		 * Courier, etc.), the font style (bold, italic, etc.), and point size.
		 * The flip value allows to reverse the Font's Y-axis downwards
		 * orientation.
		 * <p>
		 * Sample characters:
		 * 
		 ...
		 * 
		 * @param chars
		 *            characters from which to generate an AWT Shape
		 * @param font
		 *            the Java 2D Font used to create the glyphs
		 * @param flip
		 *            if <code>true</code> the Font's Y-axis downwards
		 ...
		 * @return an AWT Shape
		 */
		public Shape createAWTShape(char[] chars, Font font, boolean flip) {
			...
			/*
			 * Rectangle2D bnd = gv.getVisualBounds(); double tx = bnd.getX() +
			 * 0.5 bnd.getWidth(); double ty = bnd.getY() + 0.5 bnd.getHeight();
			 * trans.setToTranslation(-tx, -ty); trans.scale(1.0, -1.0);
			 * trans.translate(tx, -ty);
			 */
			// V 1.3
			trans.setToScale(1.0, -1.0); // Mirrored at y = 0, no center
			// transform needed !
		...
		private void transformGeometry(Transform3D transform, float[] triple,
				boolean isNormal) {
			...
			if (isNormal) {
				...
				for (int i = 0; i < tripleCt; i++) {
					...
					// Normalize
					float nLength = (float) Math.sqrt(xt * xt + yt * yt + zt
							* zt);
					if (nLength != 0)
				...
				for (int i = 0; i < tripleCt; i++) {
					...
					triple[k++] = mat[8] * x + mat[9] * y + mat[10] * z
					+ mat[11];
				}
			}
		}
		...
		private void transformCoords(Transform3D transform,
				ArrayList<? extends Tuple3f> triple) {
		...
		LineStripArray createLineStripGeometry(PathIterator pIt,
				boolean inclNormals, boolean byReference, boolean geomTransform) {
			...
			while (!pIt.isDone()) {
				...
				if (flag == PathIterator.SEG_CLOSE) {
					...
					if (num > 0) {
						if (num > 2) {
							...
							//
							if (firstPntx != lastVertex.x
									|| firstPnty != lastVertex.y) {
								coordsList.add(new Point3f(firstPntx,
										firstPnty, 0));
								num++;
								numPoints++;
							}
				...
				// The segment type constant for a point that specifies
				// the end point of a line to be drawn from the most recently
				// specified point.
			...
			LineStripArray lineStripArray = new LineStripArray(vertexCt,
					vertexFormat, stripVertexCounts);
			if (byReference) {
				int k = 0;
				...
				if (inclNormals) {
					...
					if (geomTransform && !isIdentityTransform) {
						...
						this
						.transformGeometry(normalTransform, normalArr,
								true);
		...
		GeometryArray createGeometry(PathIterator pIt, boolean byReference,
			...
			while (!pIt.isDone()) {
				...
				if (flag == PathIterator.SEG_CLOSE) {
					...
					// Single Contour done
					if (num > 0) {
						//System.out.println("AWTShapeExtruder SEG_CLOSE num = "
						// + num);
						if (num > 2) {
							// V 1.1
							// first vertex != last vertex needed !!
							...
							if (firstPntx == lastVertex.x
								...
								/*
								 * V 1.6 'lastIndVert == maxYIndex' can't
								 * happen, because in this case 'first index =
								 * maxYIndex' // V 1.2 Check if maxYIndex is
								 * removed if (lastIndVert == maxYIndex) { int
								 * lastIndMax = maxYIndices.size()-1;
								 * 
								 ...
								 */
								/*
								 * System.out.println("AWTShapeExtruder first Pnt = "
								 * + firstPntx + " / " + firstPnty);
								 * System.out.println
								 * ("AWTShapeExtruder lastVertex = " +
								 * lastVertex);System.out.println(
								 * "AWTShapeExtruder SEG_CLOSE first vertex != last vertex needed numPoints = "
								 * + numPoints);
								 */
							}
						}
				...
				// the starting location for a new subpath.
					...
					// 'num > 0' -> no SEG_CLOSE -> finish the contour here TODO
					// or throw an exception
					// Single Contour done
					if (num > 0) {
						// V 1.1
						// first vertex != last vertex needed !!
						if (firstPntx == tmpCoords[0]
						                           && firstPnty == tmpCoords[1]) {
							coordsList.remove(coordsList
									.get(coordsList.size() - 1));
							num--;
							numPoints--;
						}
				...
				// specified point.
					...
					// Check here for duplicate points.
					// Code later in this function can not handle duplicate
					// points.
					if ((vertex.x == lastX) && (vertex.y == lastY)) {
						pIt.next();
						continue;
					...
					System.out
					.println("AWTShapeExtruder flag = pIt.currentSegment = "
							+ flag);
				}
			...
			/*
			 * Point3f p3f = null; for (int n=0; n < vertices.length; n++) { p3f
			 * = vertices[n]; System.out.println(" vertices = " + p3f.x + " / "
			 * + p3f.y + " / " + p3f.z); }
			 * 
			...
			if (endIdx - beginIdx > 0) {
				...
				/*
				 * System.out.println("AWTShapeExtruder p1    = " + p1.x + " / "
				 * + p1.y + " / " + p1.z);
				 * System.out.println("AWTShapeExtruder p2    = " + p2.x + " / "
				 * + p2.y + " / " + p2.z);
				 * System.out.println("AWTShapeExtruder p3    = " + p3.x + " / "
				 * + p3.y + " / " + p3.z);
				 */
				if (p3.x != p2.x) {
					if (p1.x != p2.x) {
						// Use the one with smallest slope
						if (Math.abs((p2.y - p1.y) / (p2.x - p1.x)) > Math
								.abs((p3.y - p2.y) / (p3.x - p2.x))) {
			...
			// System.out.println("AWTShapeExtruder flip_side_orient = " +
			// flip_side_orient);
			// System.out.println("AWTShapeExtruder contours.size = " +
			// contours.size());
			...
			// v 1.3
			boolean isFrontBackAndFlat = (shapeExtrusion != null && shapeExtrusion
					.getDepth() == 0.0f);
			...
			// Second term is for side-faces along depth of the font
				...
				if (isFrontBackAndFlat) // v 1.3
					...
					vertCnt = vertOffset * 2 + numPoints * 6
					* (shapeExtrusion.getExtrusion().length - 1);
				}
			}

			// To create triangles for side faces, every vertex is duplicated
			// currently.
			...
			for (j = 0; j < numIslands; j++) {
				...
				for (i = 0; i < vertOffset; i += 3, currCoordIndex += 3) {
					...
					if (!findOrient) {
						// Check here if triangles are wound incorrectly and
						// need
						// to be flipped.
						if (!getNormal(p1, p2, p3, nz)) {
							// this creates a degenerated triangle: should never
							// happen
							// System.out.println("findOrient 0 = " + j + " / "
							// + p1 + " / " + p2 + " / " +p3);
							continue;
						}
						...
						if (nz.z >= EPS) {// 0.000001f; +Z
							...
							flip_orient[j] = true;
							// System.out.println(
							// "findOrient j / i / flip_orient[j] = " +j +" / "+
							// i + " / true");
						} else {
							// this creates a degenerated triangle: should never
							// happen
							// System.out.println("findOrient 1 = "+ nz.z +
							// " / " + p1 + " / " + p2 + " / " +p3);
							continue;
						}
					...
					if (flip_orient[j]) {
						// New Triangulator preserves contour orientation. If
						// contour
						// input is wound incorrectly, swap 2nd and 3rd points
						// to
					...
					if (shapeExtrusion != null) { // incl. isFrontBackAndFlat
						// (depth == 0.0)
						...
						q1.x = p1.x;
						q1.y = p1.y;
						q1.z = p1.z + shapeExtrusion.getDepth();
						q2.x = p2.x;
						q2.y = p2.y;
						q2.z = p2.z + shapeExtrusion.getDepth();
						q3.x = p3.x;
						q3.y = p3.y;
						q3.z = p3.z + shapeExtrusion.getDepth();
			...
			if (shapeExtrusion != null && !isFrontBackAndFlat) { // v 1.3
				...
				// straight bevel extrusion shape, a straight line from 0.0 to
				// depth
				if (shapeExtrusion.getExtrusionShape() == null) {
					...
					for (i = 0; i < numIslands; i++) {
						...
						for (j = 0, k = 0, num = 0; j < islandCounts[i].length; j++) {
							...
							for (; k < num; k++) {
								...
								// if there is a previous normal, see if we need
								// to smooth
								...
								// if there is a next, check if we should smooth
								// normal
					...
					// fontExtrusion.shape is specified, and is NOT straight
					// line
					for (i = 0; i < numIslands; i++) {
						...
						for (j = 0, k = 0, offset = num = 0; j < islandCounts[i].length; j++) {
							...
							for (; k < num; k++) {
								...
								p3.x = outVerts[i][(k + 1) == num ? offset
										: (k + 1)].x;
								p3.y = outVerts[i][(k + 1) == num ? offset
										: (k + 1)].y;
								p3.z = 0.0f;
								...
								// Calculate normals at the point by averaging
								// normals
								...
								if (isFirst) {
									 ...
									 * );
									 * System.out.println("Extruder: cosa  = " +
									 * cosa + " / "
									 * +Math.toDegrees(Math.acos(cosa))); double
									 * angle = nna.angle(nn1);
									 * System.out.println("Extruder: angle = " +
								...
								/*
								 * System.out.println("Extruder: cosb  = " +
								 * cosb + " / "
								 * +Math.toDegrees(Math.acos(cosb))); double
								 * angle = nnb.angle(nn3);
								 * System.out.println("Extruder: angle = " +
								 * angle + " / " + Math.toDegrees(angle));
								 * System.out.println(
								 ...
								 * );
								 */
								// Run along the extrusion border from back face
								// to front face
								for (m = 1; m < extrPntsLength; m++) {
									// v 1.5
									if (shapeExtrusion.isT3DStyleExtrusion()) {
										q1.x = P1.x + nna.x * extrPnts[m].y; // a
										// la
										// Text3D
									...
									/*
									 * ?? v 1.5 if (!getNormal(p1, q1, p2, n)) {
									 * n.set(goodNormal); } else { if
									 * (!flip_side_orient) { n.negate(); }
									 * goodNormal.set(n); }
									 */

									// V 1.2
									// Normal calculation will be done in
									// NormalGenerator
									// for smooth shading according to crease
									// angle
									if (flip_side_orient) {
					...
					// Geometry transform V 1.7
					// Transform coords only, normals will be done by
					// NormalGenerator
					if (geomTransform && !isIdentityTransform) {
						this.transformCoords(coords);
					}
					...
					// V 1.1
					GeometryInfo giShape = new GeometryInfo(
		...
		private boolean getNormal(Point3f p1, Point3f p2, Point3f p3,
				Vector3f normal) {
			Vector3f v1 = new Vector3f();
			Vector3f v2 = new Vector3f();

			/*
			 * v1.sub(p2, p1); v2.sub(p2, p3); normal.cross(v1, v2);
			 * normal.negate();
			 */
			// V 1.7
			v1.sub(p2, p1);
			...
			// System.out.println("getNormal false length = " +length +" / " +
			// p1 + " / " + p2 + " / " +p3);
			return false;
		}
		...
		private Point3f[] removeDegeneratedTrias(GeometryArray ga) {
			...
			for (int i = 0; i < length; i += 3) {
				 ...
				 * System.out.println("removeDegeneratedTrias = " + p1 + " / " +
				 * p2 + " / " +p3); continue; } if ( (p2.y - p1.y)/(p2.x - p1.x)
				 * == (p3.y - p2.y)/(p3.x - p2.x)) {
				 * System.out.println("removeDegeneratedTrias slope  = "
				 * +n.length()+" / " + p1 + " / " + p2 + " / " +p3); continue; }
				 */
				// V 1.7
				v1.sub(p2, p1);
				v2.sub(p3, p1);
				...
				if (n.length() > 0.0f) {
					...
					// System.out.println("removeDegeneratedTrias length = "+n.
					// length()+" / " + p1 + " / " + p2 + " / " +p3);
			...
			if (k == length) {
				...
				//System.out.println("removeDegeneratedTrias : (k != length) = "
				// + k + " / " + length);
		...
		private final class IslandsNode {
			...
			void insert(IslandsNode newNode, Point3f[] vertices) {
				...
				if (islandsList != null) {
					...
					for (int i = numChild() - 1; i >= 0; i--) {
						...
						status = check2Contours(newNode.startIdx,
								newNode.endIdx, childNode.startIdx,
								childNode.endIdx, vertices);
						switch (status) {
			...
			private void collectOddLevelNode(ArrayList<IslandsNode> list,
					int level) {
				if ((level % 2) == 1) {
					list.add(this);
				}
			...
			private int check2Contours(int begin1, int end1, int begin2,
					int end2, Point3f[] vertices) {
				int i;
				boolean inside2, inside1;

				inside2 = pointInPolygon2D(vertices[begin1].x,
						vertices[begin1].y, begin2, end2, vertices);

				for (i = begin1 + 1; i < end1; i++) {
					if (pointInPolygon2D(vertices[i].x, vertices[i].y, begin2,
							end2, vertices) != inside2) {
				...
				// if we are not checking the reverse for all points. This
				// happen
				// when two points form a line pass through a polygon but the
				// two
				// points are outside of it.

				inside1 = pointInPolygon2D(vertices[begin2].x,
						vertices[begin2].y, begin1, end1, vertices);

				for (i = begin2 + 1; i < end2; i++) {
					if (pointInPolygon2D(vertices[i].x, vertices[i].y, begin1,
							end1, vertices) != inside1) {
						return 1; // intersecting contours
					}
				}
			...
			// z-value of polygon vertices is ignored. Sent only to avoid
			// data-copy.
			// Uses ray-shooting algorithm to compute intersections along +X
			// axis.
			// This algorithm works for all polygons(concave, self-intersecting)
			// and
			// is best solution here due to large number of polygon vertices.
			// Point is INSIDE if number of intersections is odd, OUTSIDE if
			// number
			// of intersections is even.
			private boolean pointInPolygon2D(float x, float y, int begIdx,
					int endIdx, Point3f[] verts) {
				...
				for (i = begIdx; i < endIdx - 1; i++) {
					...
					xi = verts[i].x + (verts[i].x - verts[i + 1].x)
					* (y - verts[i].y) / (verts[i].y - verts[i + 1].y);
				...
				if (!((verts[i].y >= y && verts[begIdx].y >= y) || (verts[i].y < y && verts[begIdx].y < y))) {
					xi = verts[i].x + (verts[i].x - verts[begIdx].x)
					* (y - verts[i].y) / (verts[i].y - verts[begIdx].y);
	...
	public static void BoxAddFaces(Box box, int faceId, float faces1,
			float faces2) {
		QuadArray plane = null;
		if (faceId == 0) {
			float FLOOR_LENX = box.getXdimension();
			float FLOOR_LENY = box.getYdimension();
			float FLOOR_H = box.getZdimension();
			float STEPX = faces1;
			float STEPY = faces2;
			ArrayList<Point3f> coords = new ArrayList<Point3f>();
			for (float x = -FLOOR_LENX; x < FLOOR_LENX; x += STEPX)
				for (float y = -FLOOR_LENY; y < FLOOR_LENY; y += STEPY) {
					if (x + STEPX >= FLOOR_LENX)
						STEPX = FLOOR_LENX - x;
					else
						STEPX = faces1;
					if (y + STEPY >= FLOOR_LENY)
						STEPY = FLOOR_LENY - y;
					else
						STEPY = faces2;
					Point3f p1 = new Point3f(x, y, FLOOR_H);
					Point3f p2 = new Point3f(x + STEPX, y, FLOOR_H);
					Point3f p3 = new Point3f(x + STEPX, y + STEPY, FLOOR_H);
					Point3f p4 = new Point3f(x, y + STEPY, FLOOR_H);
					coords.add(p1);
					coords.add(p2);
					coords.add(p3);
					coords.add(p4);
			...
			plane = new QuadArray(numPoints, GeometryArray.COORDINATES
			...
			for (int i = 0; i < numPoints; i = i + 4) {
				tcoords[i] = new TexCoord2f(1, 0);
				tcoords[i + 1] = new TexCoord2f(1, 1);
				tcoords[i + 2] = new TexCoord2f(0, 1);
				tcoords[i + 3] = new TexCoord2f(0, 0);
			}
		...
		if (faceId == 2) {
			float FLOOR_LENY = box.getYdimension();
			float FLOOR_LENZ = box.getZdimension();
			float FLOOR_H = box.getXdimension();
			float STEPY = faces1;
			float STEPZ = faces2;
			ArrayList<Point3f> coords = new ArrayList<Point3f>();
			for (float y = -FLOOR_LENY; y < FLOOR_LENY; y += STEPY)
				for (float z = -FLOOR_LENZ; z < FLOOR_LENZ; z += STEPZ) {
					if (z + STEPZ >= FLOOR_LENZ)
						STEPZ = FLOOR_LENZ - z;
					else
						STEPZ = faces2;
					if (y + STEPY >= FLOOR_LENY)
						...
						STEPY = faces1;
					Point3f p1 = new Point3f(FLOOR_H, y, z);
					Point3f p2 = new Point3f(FLOOR_H, y + STEPY, z);
					Point3f p3 = new Point3f(FLOOR_H, y + STEPY, z + STEPZ);
					Point3f p4 = new Point3f(FLOOR_H, y, z + STEPZ);
					coords.add(p1);
					coords.add(p2);
					coords.add(p3);
					coords.add(p4);
		...
		if (faceId == 4) {
			float FLOOR_LENX = box.getXdimension();
			float FLOOR_LENZ = box.getZdimension();
			float FLOOR_H = box.getYdimension();
			float STEPX = faces1;
			float STEPZ = faces2;
			ArrayList<Point3f> coords = new ArrayList<Point3f>();
			for (float x = -FLOOR_LENX; x < FLOOR_LENX; x += STEPX)
				for (float z = -FLOOR_LENZ; z < FLOOR_LENZ; z += STEPZ) {
					...
					if (x + STEPX >= FLOOR_LENX)
						...
						STEPX = faces1;
					Point3f p1 = new Point3f(-x, FLOOR_H, z);
					Point3f p2 = new Point3f(-x - STEPX, FLOOR_H, z);
					Point3f p3 = new Point3f(-x - STEPX, FLOOR_H, z + STEPZ);
					Point3f p4 = new Point3f(-x, FLOOR_H, z + STEPZ);
					coords.add(p1);
					coords.add(p2);
					coords.add(p3);
					coords.add(p4);
		...
		box.getShape(faceId).setGeometry(plane);
	}
	 ...
	 * LineParticles. This allows the updater to directly access the coordinates
	 * when its updateData() method is triggered. The Behaviour subclass can
	 * refer to the LineArray.
	 */

	/*
	 * import javax.media.j3d.; import javax.vecmath.; import
	 * java.util.Enumeration;
	 */
	static float getX(int i, int j, int k) {
		float x = 0.0f;
		x = (float) i + (float) (j * cos(PI / 3.0) + (float) k
				* cos(PI / 6.0f) / sqrt(3));
		// x=(double)i;
		//return (x+10.0f);
		return (x);
	}
	static float getY(int i, int j, int k) {
		float y = 0.0f;
		y = (float) (j * sin(PI / 3.0)) + (float) (k * sin(PI/6.0)/sqrt(3));
		// y=(double)j*sin(PI/3);
		//return (y+10.0f);
		return (y);
	}
	static float getZ(int i, int j, int k) {
		float z = 0.0f;
		// z=(double)k* sqrt(2.0 / 3.0);
		z = (float)(k * sqrt(2.0f / 3.0f));

		//return (z+10.0f);
		return (z);
	}
	public static class LineParticles extends Shape3D {
		private int LINEWIDTH = 160;

		private float GRAVITY = 9.8f;
		private float TIMESTEP = 0.1f;
		private float XZ_VELOCITY = 0.0f;
		private float Z_VELOCITY = 4/* 8.0f */;

		// particle colours
		private Color3f red = new Color3f(1.0f, 0.0f, 0.0f);
		private Color3f yellow = new Color3f(1.0f, 1.0f, 0.6f);
		...
		private float[] cs, vels, accs, cols; // we must use floats
		// unfortunately
		private int numPoints;

		float zPoint_;

		public LineParticles(float zPoint, int nps, int delay) {
			zPoint_ = zPoint;
		...
		/*
		 * Initialise coords in cs[] i to i+5 (2 points / 1 line). We do things
		 * in 2 point groups since they are the two ends of a line.
		 */
		{
			Random r = new Random();
			// r.nextInt(1000);
			cs[i] = 0.0f + (float) Math.random() * 4000 - 2000;
			cs[i + 1] = 0.0f + (float) Math.random() * 4000 - 2000;
			cs[i + 2] = zPoint_ - r.nextInt(1750) /*
			 * + (float)Math.random() 2000 -
			 * 1000
			 */; // (x,y,z) at origin

			// random velocity in XY plane with combined vector XZ_VELOCITY
			double xvel = Math.random() * XZ_VELOCITY;
			double yvel = Math
			.sqrt((XZ_VELOCITY * XZ_VELOCITY) - (xvel * xvel));
			vels[i] = (float) ((Math.random() < 0.5) ? 0 : 0/*-xvel : xvel*/); // x
			// vel
			vels[i + 1] = (float) ((Math.random() < 0.5) ? 0 : 0/* -yvel : yvel */); // y
			// vel
			vels[i + 2] = (float) (Math.random() * Z_VELOCITY); // z velocity
			...
			// Color3f c = new Color3f(0.8f, 1.0f, 1.0f);
			// set initial colours for the first particle
			Color3f col = (Math.random() < 0.5) ? new Color3f(0.7f, 1.0f, 1.0f)
		...
		/*
		 * Calculate the particle's new position and velocity (treating is as a
		 * projectile). The acceleration is constant.
		 */
		{
			// cs[i] += vels[i] * TIMESTEP + 0.5 * accs[i] * TIMESTEP *
			// TIMESTEP; // x coord
			// cs[i+1] += vels[i+1] * TIMESTEP + 0.5 * accs[i+1] * TIMESTEP *
			// TIMESTEP; // y coord
			cs[i + 2] += vels[i + 2] /**
			 * TIMESTEP + 0.5 * accs[i+2] * TIMESTEP *
			 * TIMESTEP
			 */
			                  ; // z coord
		...
		public class LinesUpdater implements GeometryUpdater {
			...
			/*
			 * An update of the geometry is triggered by the system. Rather than
			 * use geo, we directly access the cs[] array back in LineParticles.
			 */
			{ // GeometryArray ga = (GeometryArray) geo;
				...
				// step in 6's == two (x,y,z) coords == one line
				for (int i = 0; i < numPoints * 3; i = i + 6) {
					if ((cs[i + 2] < 0.0f) && (cs[i + 5] < 0.0f))
						// both particles in the line have dropped below the
						// y-axis
		...
		// Request an update every timedelay ms by using the updater object.
		{
			...
			public void processStimulus(Enumeration criteria) { // ignore
				// criteria
				// update the line array by calling the updater
				lineParts.updateData(updater); // request an update of the
				// geometry
				wakeupOn(timedelay);
			}
